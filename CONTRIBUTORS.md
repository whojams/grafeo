...
- **Michaelzag** ([@Michaelzag](https://github.com/Michaelzag)): `cypher` feature `gql` dependency fix ([#233](https://github.com/GrafeoDB/grafeo/pull/233)), schema type extraction proposal ([#234](https://github.com/GrafeoDB/grafeo/issues/234)), Python named graph management ([#243](https://github.com/GrafeoDB/grafeo/pull/243)), Python per-transaction CDC ([#244](https://github.com/GrafeoDB/grafeo/pull/244)), graph/schema context validation ([#246](https://github.com/GrafeoDB/grafeo/pull/246))
